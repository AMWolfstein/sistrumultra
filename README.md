...
Detailed architecture docs (engineering rules, the mobile UI catalog) live in
the `catalog/` folder of the original misa198/airmedy monorepo, not in this repo.
